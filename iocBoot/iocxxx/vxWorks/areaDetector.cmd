...
dbLoadRecords("$(ADCORE)/ADApp/Db/ADBase.template",     "P=xxx:,R=cam1:,PORT=SIM1,ADDR=0,TIMEOUT=1")
dbLoadRecords("$(ADCORE)/ADApp/Db/simDetector.template","P=xxx:,R=cam1:,PORT=SIM1,ADDR=0,TIMEOUT=1")

# Create a second simDetector driver
simDetectorConfig("SIM2", 300, 200, 1, 50, 50000000)
dbLoadRecords("$(ADCORE)/ADApp/Db/ADBase.template",     "P=xxx:,R=cam2:,PORT=SIM2,ADDR=0,TIMEOUT=1")
dbLoadRecords("$(ADCORE)/ADApp/Db/simDetector.template","P=xxx:,R=cam2:,PORT=SIM2,ADDR=0,TIMEOUT=1")
...
#dbLoadRecords("$(ADCORE)/ADApp/Db/EPICS_AD_Viewer.template", "P=xxx:, R=image1:")
...
dbLoadRecords("$(ADCORE)/ADApp/Db/NDROIN.template", "P=xxx:,R=ROI1:0:,PORT=SIM1ROI,ADDR=0,TIMEOUT=1,HIST_SIZE=256")
dbLoadRecords("$(ADCORE)/ADApp/Db/NDROIN.template", "P=xxx:,R=ROI1:1:,PORT=SIM1ROI,ADDR=1,TIMEOUT=1,HIST_SIZE=256")
dbLoadRecords("$(ADCORE)/ADApp/Db/NDROIN.template", "P=xxx:,R=ROI1:2:,PORT=SIM1ROI,ADDR=2,TIMEOUT=1,HIST_SIZE=256")
dbLoadRecords("$(ADCORE)/ADApp/Db/NDROIN.template", "P=xxx:,R=ROI1:3:,PORT=SIM1ROI,ADDR=3,TIMEOUT=1,HIST_SIZE=256")
