...
#Creates devices serial0:0 through serial0:7
...
#Creates serial1:0 through serial1:7
#iocshLoad("$(IPAC)/iocsh/tyGSOctal.iocsh", "INSTANCE=UART_1, PORT=serial1:, TYPE=232, CARRIER=0, SLOT=1, INT_VEC=0x80")

#Loads asyn records for serial1:0 through serial1:7, calls them asyn_9 through asyn_16 for user compatibility
